...
# Nutzungsprotokoll
## Verwendete Prompt:
Ich speichere im moment mein Model als pth Datei, die enthält jedoch nur die Gewichte und macht mein späteres deployen schwerer, ich würde für das deployen gerne .onnx verweden, was muss ich dafür ändern und beachten und warum hier die Datei die im moment trainiert:
Code train.py

## Antwort der KI
Warum ich onnx nutzen und die verschiedenen Wege wie


## Wofür wurde die Antwort genutzt und inwiefern wurde sie überarbeitet ?
Ich habe onnx für die interference eingebaut. Ich habe mit Vorschläge gegeben lassen wie man das einbaut und simplere übernohmen und als es das backend komplett umbauen wollte, es dazu gezwungen es einfacher zu machen
...
Es war hilfreich,um onnx einzurichten, man musste aber darauf achten das es den bestehenden code nicht komplett umbaut