...
Sobald Task 3 gestartet wird, soll ein Witz über müll durch ein LLM generiert werden.

Vorgehen:
Analysiere die Implementierung von Task 1, wie dort ein llm verwendet wird.
Erstelle anschließend einen kurzen, humorvollen Witz über Müll.
Der Witz soll verständlich, jugendfrei und maximal 1–2 Sätze lang sein.
Gib ausschließlich den Witz als Ausgabe zurück.

Beispiel: Warum hat der Müllsack einen Deckel? Damit der Müll nicht rauskommt!
